...
export function getMockMedicalSummary() {
...
export function addMockConsultationNote(payload) {
    const created = {
...
export function addMockPrescription(payload) {
    const created = {
...
export function addMockLabRequest(payload) {
    const created = {
