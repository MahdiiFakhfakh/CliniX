...
export default function DoctorTabsLayout() {
    ...
    return (<Tabs screenOptions={{
      ...
      <Tabs.Screen name="patient/[patientId]" options={{
            href: null,
        }}/>
      <Tabs.Screen name="patient/[patientId]/note" options={{
            href: null,
        }}/>
      <Tabs.Screen name="patient/[patientId]/prescription" options={{
            href: null,
        }}/>
      <Tabs.Screen name="patient/[patientId]/lab-request" options={{
            href: null,
        }}/>
      <Tabs.Screen name="chat" options={{
            href: null,
        }}/>
      <Tabs.Screen name="clinix-ai" options={{
            href: null,
        }}/>
