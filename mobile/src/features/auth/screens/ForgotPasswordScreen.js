...
export function ForgotPasswordScreen() {
    ...
    return (<Screen title="Forgot Password" subtitle="Enter your email to receive password reset instructions.">
      <Card>
        <View style={styles.form}>
          <FormTextField control={control} name="email" label="Email" placeholder="name@clinix.app" keyboardType="email-address"/>
          <PrimaryButton label={mutation.isPending ? 'Sending...' : 'Send Reset Link'} loading={mutation.isPending} onPress={onSubmit}/>
        </View>
      </Card>
