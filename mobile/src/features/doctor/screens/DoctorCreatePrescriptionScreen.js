...
export function DoctorCreatePrescriptionScreen() {
    ...
    return (<Screen title="Create Prescription" subtitle="Draft with AI then finalize dosage and instructions.">
      ...
      <Card>
        ...
        <PrimaryButton label={createMutation.isPending ? 'Saving...' : 'Save Prescription'} loading={createMutation.isPending} onPress={onSubmit}/>
      </Card>
    </Screen>);
}
