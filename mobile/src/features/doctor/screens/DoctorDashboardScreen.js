...
export function DoctorDashboardScreen() {
  ...
  const isRefreshing =
    scheduleQuery.isRefetching || alertsQuery.isRefetching;
  ...
  if (scheduleQuery.isLoading || alertsQuery.isLoading) {
    return (
      <Screen
        ...
        subtitle="Loading schedule and alerts..."
        scroll={false}
      >
        <LoadingView />
      </Screen>
  ...
  return (
    <Screen
      title={`Welcome, ${
        session?.user.profile.fullName ?? 'Doctor'
      }`}
      subtitle="Today schedule and critical alerts."
    ...
    >
      ...
      <View style={styles.actions}>
        ...
        <PrimaryButton
          ...
          onPress={() =>
            router.push('/(app)/(doctor)/patients')
          }
        />
        <PrimaryButton
          label="Open CliniX AI"
          onPress={() =>
            router.push('/(app)/(doctor)/clinix-ai')
          }
        />
      </View>
    </Screen>
