...
export function DoctorCreateNoteScreen() {
    ...
    return (<Screen title="Create Note" subtitle="SOAP template: Subjective, Objective, Assessment, Plan.">
      <Card>
      ...
      <PrimaryButton label={aiDraftMutation.isPending ? 'Generating Draft...' : 'Generate AI Draft'} loading={aiDraftMutation.isPending} onPress={handleAIDraft}/>
      ...
      <Card>
        <View style={styles.form}>
          ...
          <PrimaryButton label={createMutation.isPending ? 'Saving...' : 'Save SOAP Note'} loading={createMutation.isPending} onPress={onSubmit}/>
        </View>
      </Card>
    </Screen>);
}
