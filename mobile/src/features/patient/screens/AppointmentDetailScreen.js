...
export function AppointmentDetailScreen() {
    ...
    if (appointmentsQuery.isLoading) {
        return (<Screen title="Appointment Details" subtitle="Loading details..." scroll={false}>
        <LoadingView />
      </Screen>);
    }
    if (!appointment) {
        return (<Screen title="Appointment Details" subtitle="Appointment not found.">
        <EmptyState title="Not found" subtitle="This appointment may have been removed."/>
      </Screen>);
    }
    return (<Screen title="Appointment Details" subtitle="Review and update your appointment.">
      ...
      <Card>
        ...
        <View style={styles.form}>
          ...
          <PrimaryButton label={updateMutation.isPending ? 'Saving...' : 'Save Changes'} loading={updateMutation.isPending} onPress={onSave}/>
          <PrimaryButton label={cancelMutation.isPending ? 'Cancelling...' : 'Cancel Appointment'} loading={cancelMutation.isPending} onPress={onCancel}/>
        </View>
      </Card>
    </Screen>);
}
