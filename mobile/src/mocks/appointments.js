...
let mockAppointmentStore = [...baseAppointments];
function copyAppointments(appointments) {
...
export function updateMockAppointment(payload) {
...
export function cancelMockAppointment(appointmentId) {
    let updatedAppointment = null;
    mockAppointmentStore = mockAppointmentStore.map((item) => {
