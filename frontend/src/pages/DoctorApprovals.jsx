      ...
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <button
            ...
            className="self-start md:self-auto px-4 py-2 bg-white text-slate-700 rounded-lg hover:bg-slate-50 transition-all flex items-center gap-2 border border-slate-300 shadow-sm"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          ...
          <div className="bg-white p-6 rounded-lg border border-slate-200 shadow-sm">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-slate-500">Approve Action</p>
                <p className="text-sm font-semibold text-green-700 mt-2">
                  Sets status to Available
                </p>
                <p className="text-xs text-slate-500 mt-1">Doctor can log in</p>
              </div>
          ...
          <div className="bg-white p-6 rounded-lg border border-slate-200 shadow-sm">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-slate-500">Reject Action</p>
                <p className="text-sm font-semibold text-red-700 mt-2">
                  Permanently removes account
                </p>
                <p className="text-xs text-slate-500 mt-1">Cannot be undone</p>
              </div>
        ...
        {pendingDoctors.length === 0 ? (
          <div className="bg-white rounded-lg shadow-xl border border-slate-200 p-16 text-center">
            <div className="bg-gradient-to-br from-green-50 to-emerald-100 w-24 h-24 rounded-lg flex items-center justify-center mx-auto mb-6">
          ...
          <div className="space-y-4">
            ...
            {pendingDoctors.map((doctor) => {
              ...
              return (
                <div
                  key={doctor._id}
                  className="bg-white rounded-lg border border-slate-200 shadow-sm hover:shadow-md transition-all p-6"
                >
                  <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                    {/* Avatar + Name */}
                    <div className="flex items-center gap-4 flex-1 min-w-0">
                      <div className="w-14 h-14 rounded-lg bg-gradient-to-br from-orange-400 to-amber-500 flex items-center justify-center text-white text-xl font-bold flex-shrink-0">
                    ...
                    <div className="flex items-center gap-3 flex-shrink-0">
                      <button
                        ...
                        disabled={isActing}
                        className="flex items-center gap-2 px-5 py-2.5 bg-green-600 text-white rounded-lg hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all font-semibold shadow-sm"
                      >
                      ...
                      <button
                        ...
                        disabled={isActing}
                        className="flex items-center gap-2 px-5 py-2.5 bg-red-50 text-red-600 border border-red-200 rounded-lg hover:bg-red-100 disabled:opacity-50 disabled:cursor-not-allowed transition-all font-semibold"
                      >
